...
const event: BotEvent = {
    ...
    execute: async (oldMember: GuildMember | PartialGuildMember, member: GuildMember) => {
        ...
        const timeout = member.communicationDisabledUntilTimestamp && member.communicationDisabledUntilTimestamp > new Date().getTime() && (!oldMember.communicationDisabledUntilTimestamp || oldMember.communicationDisabledUntilTimestamp < new Date().getTime());
