...
export const MAX_FILE_SIZE = 4000000;                           // b - any file larger than this limit will be ignored
export const MAX_ATTACHMENTS_SIZE = 20000000;                   // b - max attachments size for 1 message
